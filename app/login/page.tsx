...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    if (error) {
      alert(
        "E-Mail oder Passwort ist falsch. Falls Sie bereits registriert sind, prüfen Sie Ihr Passwort oder setzen Sie es zurück."
      );
      return;
    }
  ...
  async function handleForgotPassword() {
    ...
    alert(
      "Falls für diese E-Mail-Adresse ein Konto besteht, wurde eine E-Mail zum Zurücksetzen des Passworts versendet."
    );
  }
